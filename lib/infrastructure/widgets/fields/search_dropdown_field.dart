...
typedef Widget DialogItemWidgetBuilder<T>(BuildContext context, T item, bool isSelected);
            ...
            StreamBuilder<T>(
              ...
              builder: (context, snapshot) {
                ...
                if (widget.onClear != null && hasData(snapshot.data)) {
                  ...
                  suffixButton = suffixButton = FieldButton.arrowDown(enable: widget.enable);
                }

                return GestureDetector(
                    onTap: widget.enable
                        ? () {
                            if (widget.onOpenDropdown != null && !widget.onOpenDropdown()) {
                              return;
                            }
                    ...
                    child: (widget.dropdownBuilder != null)
                        ...
                        : InputDecorator(
                            ...
                            child: Text(
                              hasData(snapshot.data) ? snapshot.data.toString() : widget.hintText ?? '',
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: theme.textStyles.body
                            .copyWith(color: snapshot.hasData ? theme.data.errorColor : Colors.transparent),
                      ),
                    ),
                  );
                },
...
class _SearchDropdownDialog<T> extends StatefulWidget {
  ...
  static Future<T> showModal<T>(
    ...
    return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          insetPadding: EdgeInsets.all(Space.xl),
  ...
  @override
  _SearchDropdownDialogState<T> createState() => _SearchDropdownDialogState<T>(onChange, onFind);
}
...
class _SearchDropdownDialogState<T> extends State<_SearchDropdownDialog<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints: widget.constraints ??
          BoxConstraints(
              minHeight: mediaQuery.size.longestSidePercent(30),
              maxHeight: mediaQuery.size.longestSidePercent(70),
              maxWidth: mediaQuery.size.shortestSidePercent(70),
              minWidth: mediaQuery.size.shortestSidePercent(70)),
      child: Column(
        children: <Widget>[
          Padding(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasError) {
                    if (widget.errorBuilder != null) {
                      ...
                      return Center(child: BackgroundHint.unExpectedError(context));
                    }
                    ...
                    if (widget.loadingBuilder != null) {
                      ...
                      return CustomScrollView(slivers: [
                        SliverFillRemaining(
                            hasScrollBody: false,
                            child: Center(child: BackgroundHint.loading(context, localizer.loading)))
                      ]);
                    }
                    ...
                    if (widget.emptyBuilder != null) {
                      ...
                      return CustomScrollView(slivers: [
                        SliverFillRemaining(
                            hasScrollBody: false, child: Center(child: BackgroundHint.recordNotFound(context)))
                      ]);
                    }
                  }
