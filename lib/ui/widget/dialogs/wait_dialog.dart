...
class _WaitDialogBodyState extends State<_WaitDialogBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPadding(
      padding: MediaQuery.of(context).viewInsets + const EdgeInsets.symmetric(horizontal: 0, vertical: Space.xl),
              ...
              child: ConstrainedBox(
                ...
                child: Column(children: <Widget>[
                  Padding(
                    ...
                    child: WidgetFactory.circularProgressIndicator(color: appTheme.data.colorScheme.onPrimary),
                  ),
                  Expanded(
                      child: Padding(
                          ...
                          child: Text(widget.dialogMessage.messageText ?? localizer.loading,
                              ...
                              style: widget.dialogMessage.messageStyle ??
                                  appTheme.textStyles.bodyBold.copyWith(color: appTheme.data.colorScheme.onPrimary))))
                ]),
              ),
            ),
          ),
