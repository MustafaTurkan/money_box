    ...
    return InputDecorator(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<T>(
            ...
            onChanged: onChanged,
            items: items,
            hint: Text(hintText ?? '', style: hintStyle ?? appTheme.data.inputDecorationTheme.hintStyle),
            disabledHint:
                Text(disabledHintText ?? '', style: disabledHintStyle ?? appTheme.data.inputDecorationTheme.hintStyle)),
      ),
    );
  }
}
